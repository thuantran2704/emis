...
export default function ImplantInfo({ language }) {
  ...
  const SectionHeading = ({ number, title }) => (
    <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-6 scroll-mt-32 flex items-center gap-3">
  ...
  return (
    <main className="min-h-screen bg-[#f7f4ec] pt-24">
      <Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pb-16">
        ...
        {/* WHITE CONTENT BOX */}
        <div className="bg-white/95 backdrop-blur-sm shadow-[0_4px_20px_rgba(0,0,0,0.08)] rounded-2xl p-6 md:p-10 lg:p-12">
          ...
          <div className="flex gap-10 relative">
            ...
            {/* ---------------- DESKTOP TOC ---------------- */}
            <aside className="hidden lg:block w-64 sticky top-32 h-max bg-white border border-gray-200 shadow-sm rounded-xl p-6">
            ...
            {/* ---------------- MOBILE TOC BUTTON ---------------- */}
            <button
              className="lg:hidden fixed bottom-6 right-6 bg-yellow-600 text-white px-4 py-3 rounded-full shadow-xl text-sm font-semibold z-40"
            ...
            <article className="flex-1 text-gray-800 text-lg leading-relaxed space-y-14">
              ...
              <section id="section1">
                ...
                <p className="mb-4">
                  {isViet
                    ...
                    : "A dental implant is a modern, long-term solution used to replace missing teeth..."}
                </p>
                <p>
                  {isViet
              ...
              <section id="section2">
                ...
                <p className="mb-4">
                  {isViet
                    ...
                    : "Implants are recommended for a wide range of tooth-loss situations..."}
                </p>

                <ul className="list-disc ml-6 space-y-2">
                  <li>{isViet ? "Mất một hoặc nhiều răng" : "Missing one or multiple teeth"}</li>
                  <li>{isViet ? "Tiêu xương hàm lâu năm" : "Long-term jawbone loss"}</li>
                  ...
                  <li>{isViet ? "Cầu răng cũ gây hại" : "Old dental bridges damaging natural teeth"}</li>
                </ul>
              </section>
              ...
              <section id="section3">
                ...
                <p className="mb-4">
                  {isViet
                    ...
                    : "The standard implant procedure includes five major stages..."}
                </p>
                ...
                <ol className="list-decimal ml-6 space-y-2">
                  ...
                  <li>{isViet ? "Chờ tích hợp xương" : "Osseointegration"}</li>
              ...
              <section id="section4">
                ...
                <p className="mb-6">
                  {isViet
                    ...
                    : "Below are three widely used implant systems worldwide..."}
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {brandData.map((brand, idx) => (
                    <div key={idx} className="bg-white border border-gray-200 shadow-sm rounded-xl p-5 text-center">
                      <img
                        src={brand.img}
                        alt={brand.name}
              ...
              <section id="section5">
                ...
                <ul className="list-disc ml-6 space-y-2">
                  <li>{isViet ? "Chụp CT đánh giá xương" : "CT scan to evaluate bone health"}</li>
                  <li>{isViet ? "Thông báo bệnh lý" : "Inform dentist about health conditions"}</li>
                  <li>{isViet ? "Tránh rượu, thuốc lá" : "Avoid smoking & alcohol"}</li>
                  <li>{isViet ? "Vệ sinh răng miệng" : "Maintain proper oral hygiene"}</li>
                </ul>
              </section>
              ...
              <section id="section6">
                ...
                <ul className="list-disc ml-6 space-y-2">
                  <li>{isViet ? "Chườm lạnh 24 giờ đầu" : "Use ice packs during first 24 hours"}</li>
                  <li>{isViet ? "Ăn mềm" : "Eat soft foods"}</li>
                  <li>{isViet ? "Không hút thuốc" : "Avoid tobacco"}</li>
              ...
              <section id="section7">
                ...
                <ul className="list-disc ml-6 space-y-2">
                  <li>{isViet ? "Trang thiết bị hiện đại" : "Advanced medical equipment"}</li>
                  <li>{isViet ? "Bác sĩ kinh nghiệm" : "Highly experienced dentists"}</li>
                  <li>{isViet ? "Trụ Implant chính hãng" : "Certified implant systems only"}</li>
                </ul>
              </section>
