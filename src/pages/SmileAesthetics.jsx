    ...
    <main className="min-h-[calc(100vh-4rem)] bg-[#f7fafc] pt-20 text-[#2a3439]">
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 lg:px-12 lg:py-32">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          {heroImage ? (
            <div className="overflow-hidden rounded-2xl border border-[#dbe4ec] bg-white shadow-sm aspect-square lg:aspect-auto lg:h-[28rem]">
              <img
                src={heroImage}
                alt={content.hero?.imageAlt || 'Smile aesthetics consultation'}
                className="w-full h-full object-cover object-bottom lg:scale-125"
              />
            </div>
          ) : null}
        </div>
