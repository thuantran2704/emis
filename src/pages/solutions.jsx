    ...
    <main className="bg-[#f7fafc] text-[#2a3439] pt-20">
          ...
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {content.hero.highlights.map((item) => (
                  <div key={item} className="flex gap-2 items-start rounded-xl bg-white/80 border border-[#dde5ec] px-4 py-3">
                    ...
                    <span className="text-sm text-[#2a3439]" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
                      {item}
                    </span>
                  </div>
                ))}
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <Link to="/contact" className={ctaPrimaryClass} style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
                  {content.hero.primaryCta}
                </Link>
                <Link to="/contact" className={ctaSecondaryClass} style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className={sectionTitleClass} style={{ fontFamily: "'Playfair Display', serif" }}>
              {content.situations.title}
            </h2>
            <p className={bodyClass + ' mt-5'} style={{ fontFamily: "'Cormorant', serif" }}>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {content.situations.cards.map((item) => (
                <article key={item.title} className="rounded-2xl border border-[#dbe4ec] bg-[#f7fafc] p-5">
                  <h3 className="text-[1.15rem] text-[#2a3439] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                    {item.title}
                  </h3>
                  <p className="text-[15px] text-gray-600 leading-relaxed" style={{ fontFamily: "'Cormorant', serif" }}>
                    {item.text}
                  </p>
                </article>
              ))}
            ...
            <div className="space-y-4">
              {content.pathways.cards.map((item) => (
                <article key={item.title} className="rounded-2xl border border-[#dbe4ec] bg-white p-6">
                  <h3 className="text-[1.25rem] text-[#2a3439] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                    {item.title}
                  </h3>
                  <p className="text-[16px] text-gray-600 leading-relaxed mb-4" style={{ fontFamily: "'Cormorant', serif" }}>
                    {item.text}
                  </p>
                  <Link
                    to={item.path}
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className={assessmentImage ? 'grid md:grid-cols-[1fr_1fr] lg:grid-cols-[0.85fr_1.15fr] gap-8 items-stretch' : 'max-w-4xl mx-auto text-center'}>
            <div className="rounded-2xl border border-[#dbe4ec] bg-[#f7fafc] p-7 lg:p-8">
              ...
              <h2 className={sectionTitleClass + ' mt-3'} style={{ fontFamily: "'Playfair Display', serif" }}>
              ...
              <div className="space-y-3">
                {content.assessment.factors.map((factor) => (
                  <div key={factor.title} className="rounded-xl bg-white border border-[#dbe4ec] p-4">
                    <p className="text-[#2a3439] text-[1rem]" style={{ fontFamily: "'Playfair Display', serif" }}>
                      {factor.title}
                    </p>
                    <p className="text-[15px] text-gray-600 mt-1" style={{ fontFamily: "'Cormorant', serif" }}>
                      {factor.text}
                    </p>
                  </div>
                ))}
              ...
              <div className="mt-7 space-y-4">
                {content.team.doctors.map((doctor) => (
                  <article key={doctor.name} className="rounded-xl border border-[#e2e8ef] bg-[#f7fafc] p-4">
                    <h3 className="text-[1.15rem] text-[#2a3439]" style={{ fontFamily: "'Playfair Display', serif" }}>
                      {doctor.name}
                    </h3>
                    <p className="text-[13px] text-gray-600 mt-2" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
                      {doctor.focus}
                    </p>
                  </article>
                ))}
              ...
              <div className="mt-7 space-y-4">
                {content.overseas.timeline.map((item, index) => (
                  <article key={item.step} className="rounded-xl border border-[#e2e8ef] bg-white p-4">
                    <p className="text-[11px] uppercase tracking-[0.2em] text-[#C5AF73]" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
                      {index + 1}
                    </p>
                    <h3 className="text-[1.05rem] text-[#2a3439] mt-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                      {item.step}
                    </h3>
                    <p className="text-[15px] text-gray-600 mt-1" style={{ fontFamily: "'Cormorant', serif" }}>
                      {item.text}
      ...
      <section className="py-20 lg:py-28 bg-[#f7fafc]">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <h3 className="mt-10 text-[1.2rem] text-[#2a3439]" style={{ fontFamily: "'Playfair Display', serif" }}>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            {content.finalCta.steps.map((step, index) => (
              <article key={step} className="rounded-xl border border-[#dbe4ec] bg-white p-5">
                <p className="text-[11px] uppercase tracking-[0.22em] text-[#C5AF73]" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
                  {language === 'vietnamese' ? `Bước ${index + 1}` : `Step ${index + 1}`}
                </p>
                <p className="mt-2 text-[16px] text-[#2a3439]" style={{ fontFamily: "'Playfair Display', serif" }}>
                  {step}
                </p>
              </article>
            ))}
          ...
          <p className="text-sm text-gray-500 mt-7 italic" style={{ fontFamily: "'Cormorant', serif" }}>
